...
def test_load_directory_datasets():
    ...
    os.mkdir('datasets4')
    save_directory_datasets('datasets4', datasets, lambda filename, image: save(filename+'.png', image))
    datasets2 = load_directory_datasets('datasets4', lambda filename: load(filename))
    ...
    os.mkdir('datasets5')
    save_directory_datasets('datasets5', datasets, lambda filename, image: save(filename+'.png', image))
    datasets2 = load_directory_datasets('datasets5', lambda filename: load(filename))
...
def test_save_directory_datasets():
    ...
    os.mkdir('datasets1')
    save_directory_datasets('datasets1', datasets, lambda filename, image: save(filename+'.png', image))
    ...
    os.mkdir('datasets2')
    save_directory_datasets('datasets2', datasets, lambda filename, image: save(filename+'.png', image))
...
def test_load_datasets():
    ...
    save_datasets('datasets12', datasets, lambda filename, image: save(filename+'.png', image))
    datasets2 = load_datasets('datasets12', lambda filename: load(filename+'.png'))
...
def test_save_datasets():
    ...
    save_datasets('datasets11', datasets, lambda filename, image: save(filename+'.png', image))
